...
def front():
    ...
    if FI_TRACE:
        data["records"].append(generate_record(uuid="generated by client", type=2, message_name="product page request", service=serviceUUID))
    ...
    if FI_TRACE:
        ...
        response.headers['fi-trace'] = data
        return response
    else:
