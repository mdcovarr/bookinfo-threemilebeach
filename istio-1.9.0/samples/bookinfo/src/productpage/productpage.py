...
def front():
    ...
    product_record = {
        "message_name": "productpage",
        "service": str(serviceUUID.hex()),
        "timestamp": int(time.time()),
        "type": 2,
        "uuid": "generated by client"
    }

    data["records"].append(client_record)
    data["records"].append(product_record)
    ...
    """
        Sending Request to get Product Details
    """
    details_request = {
        "message_name": "productdetailsrequest",
        "service": str(serviceUUID.hex()),
        "timestamp": int(time.time()),
        "type": 1,
        "uuid": "generated by client"
    ...
    data["records"].append(details_request)

    product = getProduct(product_id)
    detailsStatus, details = getProductDetails(product_id, headers)

    """
        At this point we have received a response from product details application
    """
    details_response = {
        "message_name": "productdetailsresponse",
        "service": str(serviceUUID.hex()),
        "timestamp": int(time.time()),
        "type": 2,
        "uuid": "generated by client"
    }
    data["records"].append(details_response)
    ...
    """
    review_request = {
        "message_name": "productreviewsrequest",
        "service": str(serviceUUID.hex()),
        "timestamp": int(time.time()),
        "type": 1,
        "uuid": "generated by client"
    }
    data["records"].append(review_request)
    ...
    """
    review_response = {
        "message_name": "productreviewsresponse",
        "service": str(serviceUUID.hex()),
        "timestamp": int(time.time()),
        "type": 2,
        "uuid": "generated by client"
    }
    data["records"].append(review_response)
